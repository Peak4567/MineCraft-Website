...
<!-- ======= status ======= -->
		<div class="col-lg-3">		
<div class="card border-0 shadow mb-3">
    <div class="card-header bg-info" style="color: white;"><h5 class="m-0"  style="font-family:Kanit;"><i class="fa fa-user fa-fw"></i> ระบบสมาชิก</h5></div>
	   <div class="card-body">
<?php if($_SESSION['username']){ ?>
<br>
...
<a href="?page=index" class="text-decoration-none">Funnycraft DevTeam & Develop by Poonyapat </a> Copyright © 2023, All rights reserved.</h6>
</div>
</div>
</div>
</tbody>
