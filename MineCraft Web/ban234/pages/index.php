				...
				<div class="collapse navbar-collapse" id="navigation">
					...
					<ul class="navbar-nav ml-auto">
						<li class="nav-item dropdown">
							<a class="nav-link dropdown-toggle" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><?= $__language->get("themes", "ธีมเว็บไซต์") ?> <span class="caret"><!-- icon --></span></a>
