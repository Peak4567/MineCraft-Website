<?php
	if(isset($_GET['id']) && $_GET['id'] != NULL && $_GET['id'] != "")
	{
		...
		if($query_bungeecord->num_rows != 0)
		{
			...
			?>
				<h4 class="mb-3 text-center">จัดการ Server รายการสินค้า<div class='text-muted'>#<?php echo $bungeecord_f['id']; ?></div></h4>
			
				<form name="edit_bungeecord" method="POST">
					<div class="row">
						<div class="col-md-6 mb-3">
				            <label for="edit_name_server">ชื่อประเภท</label>
		...
		?>
			<form name="add_bungeecord" method="POST">
				<div class="row">
				    ...
				    <div class="col-md-6 mb-3">
				        <label for="add_port_server">RCON PORT</label>
				        <input type="text" class="form-control" id="add_port_server" name="add_port_server">
				    </div>
				    <div class="col-md-6 mb-3">
				        <label for="add_password_server">RCON PASSWORD</label>
					...
					while($list_bungeecord = $query_list_bungeecord->fetch_assoc())
					{
						...
						echo '
							<tr>
								...
								<td class="text-center"><a href="?page=backend&menu=bungeecord&id='.$list_bungeecord['id'].'" class="btn btn-primary">แก้ไข </a></td>
							</tr>
						';
					}
				}
