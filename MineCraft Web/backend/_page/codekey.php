...
?>
				...
				<div class="col-md-6">
                                ...
                                <div class="alert alert-success">วิธีการสร้าง Codes ตัวอย่าง Hbd-GUjs112</div>
			<form name="redeem_submit" method="POST">
				<div class="row">
					<div class="col-md-6 mb-3">
			            <label for="code">ตั้ง Code-Key</label>
			        ...
			        <div class="col-md-4 mb-3">
                        ...
                        <div class="card-body">
                            <h5 class="m-0"><i class="fa fa-code"></i>รายการ Code-Key ที่ยังไม่ได้ใช้งาน ( <?php echo $redeem_row; ?> ) Code</h5>
                            <br>
