<div class="container">
	<div class="card border-0 shadow mb-3 mt-5">
	<?php
...
<div class="card border-0 shadow mb-3">
    <div class="card-header bg-info" style="color: white;">
        <i class="fas fa-hand-point-right"></i> เลือกขั้นตอนทํารายการ</h5></div>
            <div class="card-body">	  
	<?php
						...
						else
						{
							...
							<div class="col p-4 d-flex flex-column position-static">
					          	...
					          	<h3 class="mb-0" style="font-family:kanit;">
					          		ชื่อสินค้า: <?php echo $buy['name']; ?> <br><h5 style="font-family:kanit;">ราคา <?php echo number_format($buy['price'],2); ?> Points<small>	(พ้อยท์)</small></h5>
								</h3>
					          	<div class="mb-1 text-muted" style="font-family:kanit;">
							...
							<div class="text-danger">
								<h5 style="font-family:kanit;">
									<i class="fa fa-gift"></i> ต้องการส่งของขวัญชิ้นนี้ให้เพื่อนงั้นหรอ? 
										</h5>
												</div>
						          	<form name="buy" method="POST">
                                                                <div class="row">
						          		<div class="col-md-6">
                                                                            <input name="gift_username" class="form-control mb-1" type="text" placeholder="กรุณากรอกชื่อผู้เล่นที่จะส่งไอเท็มนี้ให้" required=""/>
							          	</div>
							          	<div class="col-md-5">
							          		<button type="submit" name="btn_gift" class="btn btn-success btn-block">
							          			<i class="fa fa-gift"></i> ส่งของขวัญไปหาเพื่อนเลย!
							          		</button>
							          	</div>
						          	</div>
                                                                </form>
