<?php
	if(isset($_GET['id']) && $_GET['id'] != NULL && $_GET['id'] != "")
	{
		...
		if($query_user->num_rows != 0)
		{
			...
			?>
				<h5 class="mb-3 text-center">จัดการสมาชิก <div class='text-muted'>#<?php echo $user_f['id']; ?></div></h5>
	...
	else
	{
		?>
			<form name="search_user" method="POST">
				<div class="col-12 col-md-12  pull-left text-right mb-3">
			...
			<table class="table table-default table-condenseds">
				<thead>
					<tr>
						<th style="background-color: #FFF;" class="text-dark">#</th>
						<th style="background-color: #FFF;" class="text-center text-dark">USERNAME</th>
						<th style="background-color: #FFF;" class="text-center text-dark">EMAIL</th>
						<th style="background-color: #FFF;" class="text-center text-dark">IP USER</th>
						<th style="background-color: #FFF;" class="text-center text-dark">POINTS</th>
						<th style="background-color: #FFF;" class="text-center text-dark">RANK</th>
					</tr>
				</thead>
				<tbody>
					<?php
